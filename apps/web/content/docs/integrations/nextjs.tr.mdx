...
<Callout type="warn">
  Örneği tembel (lazy) oluşturun: modül seviyesinde bir `new BetterPayment(...)` yerine bir fonksiyon içinde. Aksi hâlde ortam değişkenleri yokken Next.js'in statik üretimi hata verebilir.
</Callout>
