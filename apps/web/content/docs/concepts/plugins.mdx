...
| Plugin | What it does |
| ------ | ------------ |
| [`localizedErrors`](/docs/plugins/localized-errors) | Error messages for customers, in their language (English, Turkish, and German included) |

Planned: a commission router that sends each payment to the cheapest provider ([#51](https://github.com/furkanczay/better-payment/issues/51)). Need something else? [Write your own](/docs/guides/writing-plugins); it takes a few lines.
