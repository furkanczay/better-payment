---
title: Yapılandırma
description: betterPayment() için tüm yapılandırma seçenekleri.
---

## betterPayment() seçenekleri [#betterpayment-options]
...
Seçenekler ve framework örnekleri için [BetterPaymentHandler](/docs/concepts/handler) sayfasına bakın.
