...
Planned: a commission router that sends each payment to the cheapest provider ([#51](https://github.com/furkanczay/better-payment/issues/51)). Need something else? [Write your own](/docs/plugins/writing-plugins); it takes a few lines.
