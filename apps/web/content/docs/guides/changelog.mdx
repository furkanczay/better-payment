...
- **[Plugins](/docs/plugins):** before/after hooks for provider operations, typed methods, handler endpoints and error codes. [Write your own](/docs/plugins/writing-plugins) in a few lines.
- **[Payment events](/docs/plugins/events):** one typed listener for every provider and flow, emitted only for verified results.
...
- **[Custom providers](/docs/plugins/custom-providers)** with `defineProvider()`, and WebCrypto helpers for signing.
