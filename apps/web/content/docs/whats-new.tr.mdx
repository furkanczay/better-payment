...
<Callout type="info">
  Bu sayfa 0.0.1 sıfırlamasını anlatır. 0.4'ten 0.5'e mi geçiyorsunuz (`betterPayment()` ve plugin'ler)? [0.5'e geçiş](/docs/guides/migration-0-5) sayfasına bakın.
</Callout>
...
Ayrıntılar için [BetterPaymentHandler](/docs/concepts/handler) sayfasına bakın.
...
**API kararlı mı?**
`0.x` sürümleri API'yi hâlâ değiştirebilir. Geriye uyumsuz değişiklikler her zaman geçiş notlarıyla birlikte [sürüm notlarında](/docs/reference/changelog) listelenir.
