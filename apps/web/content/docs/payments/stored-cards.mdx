...
| Parampos | not yet ([#65](https://github.com/furkanczay/better-payment/issues/65)) | — | — | — | — |
| Akbank | not yet ([#65](https://github.com/furkanczay/better-payment/issues/65)) | — | — | — | — |
...
The iyzico flow (save during payment, list, pay by token, delete) runs every night against the real iyzico sandbox. The PayTR token formulas follow PayTR's official Postman collection and have not yet been run against a PayTR account ([help wanted](https://github.com/furkanczay/better-payment/issues/62)).
